...
METADATA = Metadata(json_file='', 
                    thing_classes=['Car', 'Two-wheel Vehicle', 'Personal Mobility', 'TruckBus', 
                                   'Kid student', 'Adult','Traffic Sign', 'Traffic Light', 'Speed bump',
                                   'Parking space', 'Crosswalk'], 
...
class NIAEvaluator(DatasetEvaluator):
    """
