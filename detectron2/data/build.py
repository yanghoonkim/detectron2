...
from .common import AspectRatioGroupedDataset, DatasetFromList, MapDataset, ToIterableDataset, DatasetFromPathList
...
__all__ = [
    ...
    "build_detection_nia_test_loader",
...
@configurable(from_config=_train_loader_from_config)
def build_detection_nia_train_loader(
    dataset,
    *,
    mapper,
    sampler=None,
    ...
    if isinstance(dataset, str):
        dataset = DatasetFromPathList(dataset, copy=False)
    if mapper is not None:
        dataset = MapDataset(dataset, mapper)
...
@configurable(from_config=_test_loader_from_config)
def build_detection_nia_test_loader(
    dataset: Union[List[Any], torchdata.Dataset],
    *,
    mapper: Callable[[Dict[str, Any]], Any],
    sampler: Optional[torchdata.Sampler] = None,
